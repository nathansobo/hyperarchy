...
_.constructor("Monarch.View.Template", {
  ...
  defaultViewProperties: _.extend({}, _.Kernel, {
    ...
    registerInterest: function(object, methodName, callback, context) {
      if (!this._interestSubscriptions) this._interestSubscriptions = {};
      if (this._interestSubscriptions[methodName]) this._interestSubscriptions[methodName].destroy();
      this._interestSubscriptions[methodName] = object[methodName](callback, context);
    },

    unregisterAllInterest: function() {
      if (this._interestSubscriptions) {
        _.each(this._interestSubscriptions, function(subscription) {
