...
_.constructor("Monarch.View.Template", {
  ...
  defaultViewProperties: _.extend({}, _.Kernel, {
    ...
    registerInterest: function(object, methodName, callback, context) {
      ...
      var object = args[0], methodName = args[1], callback = args[2], context = args[3];
      ...
      this._interestSubscriptions[subscriptionName][methodName] = object[methodName](callback, context);
    },
