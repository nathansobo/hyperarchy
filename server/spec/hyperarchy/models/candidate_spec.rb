  ...
  describe Candidate do
    ...
    describe "after create" do
      ...
      it "sends a notification email to every user that has voted in the answer's election" do
        ...
        organization.memberships.make(:user => creator, :candidate_alerts => "immediately")
        organization.memberships.make(:user => opted_in_voter, :candidate_alerts => "immediately")
        organization.memberships.make(:user => opted_out_voter, :candidate_alerts => "never")
        other_org.memberships.make(:user => opted_out_voter, :candidate_alerts => "never")
        organization.memberships.make(:user => opted_in_non_voter, :candidate_alerts => "immediately")
