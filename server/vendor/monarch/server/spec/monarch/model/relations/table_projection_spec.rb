...
#            projection.to_sql.should == %{select blogs.* from blogs inner join blog_posts on blogs.id = blog_posts.blog_id where blogs.id = #{"grain".hash}}
#          end
#        end
#
...
#                blog_posts.*
#              from
#                blogs inner join blog_posts on blog_posts.blog_id = blogs.id
#              where
#                blogs.id = #{"grain".hash}
#            }.gsub(/[ \n]+/, " ").strip
#          end
